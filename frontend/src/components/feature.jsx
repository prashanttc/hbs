...
const Feature = () => {
  ...
  return (
    <div className="mx-5 md:mx-[10%] mt-10 md:mt-[8vw]">
      {" "}
      {/* Adjust margins and spacing for responsiveness */}
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
          {/* Indore */}
          <div
            className=" cursor-pointer "
            onClick={() => handleclick("indore")}
          >
            <img
              className="w-full h-[120px] sm:h-[20vw] md:h-[15vw] lg:h-[10vw] object-cover rounded-xl"
